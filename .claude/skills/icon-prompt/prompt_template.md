...
| 발주 | 첨부 | 이유 |
|---|---|---|
| 스킬 아이콘 | `icons/skills/source/sheet_02_mono_anchor.png` | **단색 실루엣**(외곽선·음영·색 없음) — 2026-09-09 부터 스킬 세트의 앵커다. 타일 문장은 [skill_tiles.md](skill_tiles.md) |
| 스킬 아이콘 (옛 스타일) | ~~`icons/skills/source/sheet_01_color.png`~~ | 1차 컬러 카툰. **설치본에서 사라졌다** — 합격선 표(SKILL.md)가 아직 이 시트 기준이라 참고로만 남긴다 |
| 무기 | `icons/items/source/examples.png` | 오브젝트 단독 · 대각선 구도 · 강조색 한 점 |
| 방어구·장신구 | `icons/items/source/examples_armor.png` | 정면 구도 · 금속 광택 단수 |
| empty 실루엣 | `icons/items/source/item_background.png` | 무채색 실루엣의 단순화 수위 |
