...
5. **전투 채널은 원정·의뢰 둘** — **관전 대상은 유저가 보고 있는 탭**이 정한다 ([GAME_DESIGN.md](docs/game_design/GAME_DESIGN.md) §1-1 · [SCREEN_DESIGN.md §1](docs/client/SCREEN_DESIGN.md)). 그 둘 말고 **탭을 늘려 전투를 복제하지는 않는다.** 영웅 띠의 "지금 하는 일"이 접속/오프라인 상태가 앉을 자리다 (§5).
