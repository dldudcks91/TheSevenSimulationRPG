...
- 섹션 주석 `/* ───── 이름 ───── */` 순서: 게임 화면 기본기 · 셸 · 공통 조각 · 원정 · 로스터 · 장비 · 리포트 · 전투 관전 · 행동 게이지/쿨 게이지 · 서브 바/세그먼트 · 스킬 · 선술집 · 도감 · **이미지 도감** · 페이퍼돌 · 인벤토리 격자 · 접이식 · 캐릭터 탭 · 새 게임 · 초반 루프 실동작 · 도움말 탭. 새 규칙은 해당 섹션 **안에** 넣는다
