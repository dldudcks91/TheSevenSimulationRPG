...
| `stageUnlocked(state, stageId)` | `→ bool` | **그 장이 열렸고**(`chapterOpen`) 첫 스테이지이거나 직전 스테이지(순서 기준)를 클리어했다 — 보스를 깨도 다음 장은 원정 랭크가 열어야 들어간다 [2026-09-24 · R152 · construction_draft §2] |
