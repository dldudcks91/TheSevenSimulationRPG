...
`export const SAVE_VERSION = 16`  [v16 = 사제 전용 무기 · R46 · 2026-09-08] [정정 2026-09-08 — 문서가 v11 에서 멈춰 있었다. 같은 문서 §4 는 이미 v15 이관을 적고 있어 자기모순이었다]
...
```
{
  version: 16, seed: uint32, createdAt: ms, savedAt: ms,
