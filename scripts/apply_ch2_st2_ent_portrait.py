"""Apply cell 1 of the user's 2x2 Ent sheet to Chapter 2 Stage 2 monster 2201 (Ent).

Cell 1 = top left, bare-handed Ent. Requires Pillow.
2201 had no portrait before, so there is nothing to back up.
"""
...
SHEET = FACES / "source/sheets/source_sheet_ch2_st2_ent_2x2.png"
READY = FACES / "source/ready/monster"
SELECTED = {
    2201: (0, 0, 1007, 1007),  # 1: top left, bare-handed Ent
}
...
def main() -> None:
    ...
    if sum(sheet.getpixel((1020, 60))[:3]) >= 90:
        raise ValueError("Expected black dividers at x 1007-1040")
