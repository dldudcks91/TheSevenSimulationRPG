...
> **이 표가 곧 `balance.csv:knob = 1` 이다** (15키, 2026-08-28). 손잡이인지 아닌지를 사람 기억이 아니라 컬럼이 들고 있어야 캘리브레이션이 재현된다 — 표와 CSV 가 갈리면 둘 중 하나가 틀린 것이다.
...
### 마지막 측정 (2026-08-28 — **CSV 형태 최적화 후 · 손잡이 미조정** · 시드 20 · Lv1 시작 파티 · 방어구 없음 · 전직 액티브 전부 켬)
