...
| `?dev=commission` | 선술집 — **받아 둔 의뢰가 선** 게시판 (2026-09-24 · SCREEN_DESIGN §14 · ADR-0352). 선술집을 끝까지 짓고 받을 수(`commission_slots` + 선술집 r2)만큼 앞 카드를 받는다 — 첫 장은 반쯤(진행 막대) · 둘째 장은 다 채운 채([수령]). `&arm=1` 이면 첫 장의 [포기]를 한 번 누른 채(「정말 포기」) |
