...
| `?dev=mats` | **제작 재료를 쥔 제련소 탭** (2026-09-15 · R96 · SCREEN_DESIGN §8-2) — 광석 · 목재는 파견이 채우는데 파견이 아직 없어 제작 칸의 [만들기]가 늘 잠긴다. 모든 레벨대의 광석 · 목재와 가루를 **레시피 표(`make_recipe.csv`)가 정한 양으로** — 부위 전부를 레벨대마다 한 번씩 만들 만큼 — 채운다 |
| `?screen=start` | 시작 화면 |
