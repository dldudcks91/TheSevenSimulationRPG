...
| `gamble.js` | **도박장 슬롯** — 심볼 · 코인 · 라인 · 판돈 표를 검증하고 **한 판을 굴려 결과를 데이터로 낸다**(판 · 맞은 라인 · 홀드 앤 스핀 걸음 · 판돈의 몇 배 · 재료 개수). **무상태 · 세이브를 모른다** — 충전 · 판돈 · 지급은 `state.js`(`gambleSpin`)가 한다 (2026-09-24 · R149) |
